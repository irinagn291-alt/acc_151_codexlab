...
struct CodexLabGetStatsUseCase: Sendable {
    private let repository: CodexLabBookRepositoryProtocol

    init(repository: CodexLabBookRepositoryProtocol) {
        self.repository = repository
    }

    func execute() async throws -> CodexLabReadingStats {
